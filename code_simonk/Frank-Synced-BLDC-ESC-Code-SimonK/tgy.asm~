...
#if defined(frank_esc)
#include "frank.inc"		; Frank's ESC (ICP PWM, I2C, UART)
...
urxc_x3d_sync:	sbr	flags0, (1<<UART_SYNC)
		frank_load_motor_id	i_temp2; Start counting down from MOTOR_ID, now read from solder jumpers, stored in TWAD
...
control_start:
	...
	; init input sources
		frank_read_addr	temp1, temp2		; reads solder jumpers into slave address
